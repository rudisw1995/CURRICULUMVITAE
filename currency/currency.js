<html>
	<head>
		<script language="JavaScript">
			<!--
			function rupiahConverter(){
			document.converter.dollar.value = document.converter.rupiah.value * 0.000070
			document.converter.pound.value = document.converter.rupiah.value * 0.000045 
			document.converter.yen.value = document.converter.rupiah.value * 0.008439
			document.converter.euro.value = document.converter.rupiah.value * 0.000062 
			}
			...
			document.converter.rupiah.value = document.converter.euro.value * 16055.68
			}
			function dollarConverter(){
			document.converter.euro.value = document.converter.dollar.value * 0.892541 
			...
			document.converter.rupiah.value = document.converter.dollar.value * 14327.81
			}
			...
			document.converter.rupiah.value = document.converter.pound.value * 22062.36
			}
			...
			document.converter.rupiah.value = document.converter.yen.value * 118.52
			}
			//-->
		</script>
	</head>	
	<body>
		...
		<table border="0">
		<tr>
		<td>Rupiah: </td><td><input type="text" name="rupiah" onChange="rupiahConverter()" /></td>
		</tr>
		<tr>
